            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="example" class="table table-responsive table-hover" cellspacing="0" width="100%" >
                        ...
                        $query = "SELECT p.id_pelamar, p.nik, p.posisi_pekerjaan, p.nama, e.mulai_kontrak, e.akhir_kontrak, e.status_pegawai
                                    FROM pelamar p
                                    LEFT JOIN econtract e ON p.nik = e.nik WHERE e.status_pegawai IS NOT NULL";
                        ...
                        while($data = mysqli_fetch_array($sql)){
                            ...
                            echo "<td>
                                    ...
                                    <a href='contract.php?nik=".$data['nik']."'>Contract</a>
                                  </td>";
                            echo "</tr>";
                            $no++;
                        }
