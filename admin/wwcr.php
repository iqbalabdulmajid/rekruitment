            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="example" class="table table-responsive table-hover" cellspacing="0" width="100%" >
                        ...
                        $query = "SELECT m.keterangan, p.id_pelamar, p.nama, p.posisi_pekerjaan, p.lokasi_seleksi, p.tgl_wwcr
                                    FROM master_pelamar m
                                    LEFT JOIN pelamar p ON m.id_pelamar=p.id_pelamar";
                        ...
                        while($data = mysqli_fetch_array($sql)){
                            ...
                            echo "<td>".$data ['tgl_wwcr']."</td>";
                            echo "<td>".$data ['keterangan']."</td>";
                            echo "<td>
                                    <a href='hasil_wwcr.php?id_pelamar=".$data['id_pelamar']."'>Ubah</a> |
                                    <a href='lihat_wwcr.php?id_pelamar=".$data['id_pelamar']."'>Lihat</a>
                                  </td>";
                            echo "</tr>";
                            $no++;
                        }
