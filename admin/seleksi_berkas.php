...
<?php 
	...
	$query = "SELECT * FROM master_pelamar where id_pelamar=$id_pelamar";
...
<html lang='en'>
  ...
  <h3>Bahasa</h3>
    ...
    <br><br>
    <h3>Status Seleksi Berkas</h3>
    <hr>
    <form action='update_rekrut.php?id_pelamar=".$data['id_pelamar']."' method='post'>
      <div class='form-group row'>
      <div class='col-sm-7 col-sm-offsite-3'>
          <select class='form-control' required='true' name='keterangan'>
