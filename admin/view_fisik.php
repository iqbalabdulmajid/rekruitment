            ...
            <div class="row">
                <div class="col-md-12">
                    <table id="example" class="table table-responsive table-hover" cellspacing="0" width="100%" >
                        ...
                        $query = "SELECT p.id_pelamar, p.posisi_pekerjaan, p.lokasi_seleksi, p.nama, p.keterangan, f.jarak_lari, f.jumlah_push_up, f.jumlah_sit_up
                                    FROM master_pelamar p
                                    LEFT JOIN fisik f ON p.id_pelamar = f.id_pelamar";
                        ...
                        while($data = mysqli_fetch_array($sql)){
                            ...
                            echo "<td>
                                    <a href='input_fisik.php?id_pelamar=".$data['id_pelamar']."'>Input</a>
                                  </td>";
                            echo "</tr>";
                            $no++;
                        }
