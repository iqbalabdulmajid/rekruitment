<?php 
    if (isset($_POST['simpan'])) {
      ...
      if ($password === $password_conf) {
        $query = mysqli_query($connect ,"INSERT INTO head_office (username,password,nama,jekel,tempat_lhr,tgl_lhr,agama,alamat,no_tlp,nip,jabatan) VALUES ('$username','$password','$nama','$jekel',' $tempat_lhr',' $tgl_lhr ',' $agama ','$alamat','$no_tlp','$nip','$jabatan')") or die("gagal : ".mysqli_error());
      } else{
        echo "
   ...
   <section class="atas" id="atas">
     <div class="container">
       <div class="row">
         <div class="col-sm-12">
          <br>
           <h2 class="text-center">Register Head Office</h2>
           <hr>
           <p class="text-center"><b>HO yang sudah terdaftar diharapkan dapat mendaftarkan HRD yang baru</b></p>
         </div>
       </div>
     </div>
   </section>
