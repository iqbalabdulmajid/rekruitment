...
<html lang="en">
  ...
  <body style="background: transparent;margin-top: 20px;">
    ...
    $id_admin = $_GET['id_head_office'];
    
    // Query untuk menampilkan data admin berdasarkan ID Admin yang dikirim
    $query = "SELECT * FROM head_office WHERE id_head_office='".$id_head_office."'";
   ...
   <!-- akhir judul -->
    ...
    <div class="container">
         <form action="pro_up_admin.php?id_admin=<?php echo $id_head_office; ?>" method="post">
